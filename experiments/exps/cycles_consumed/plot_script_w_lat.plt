...
set multiplot layout 2,2 \
              ...
              title "vm0: 64B 512 conns 3 cores vm1: 64B 4096 conns 3 cores" font "Latin Modern Roman,10"
...
set label font "Latin Modern Roman,8"
...
set label 1 "Time" at screen mleft + (xgraphsize / 2), mbottom / 2 center \
     font "Latin Modern Roman,6"
set label 2 "Cycles (phase / total)" at screen (mleft / 4), \
     1 - (1 - mtop) - (ygraphsize / 2) \
     rotate by 90 center font "Latin Modern Roman,6"
